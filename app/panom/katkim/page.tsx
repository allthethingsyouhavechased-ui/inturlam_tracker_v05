  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={<><MonthNavigator month={month} basePath="/panom/katkim" ariaLabel="Katkı analiz ayı" /><Link href="/panom" className="ui-press inline-flex min-h-10 items-center rounded-[10px] border border-border-default bg-surface px-3 text-xs font-semibold text-secondary hover:bg-surface-hover">Panoma dön</Link></>}
      />
